...
(function() {
	...
	var MODULE = angular.module('tech.ghp.eval',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/tech.ghp.eval/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/tech.ghp.eval/main/htm/about.htm'});
